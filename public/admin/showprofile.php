...
<script>
    $(() => {
        ...
        $("input, select").change(function () { //TODO: if value go back, clear name

            let val = $(this).parents("div[array]")[0];
            this.name = `${val.id}[${this.id}]`;
...
<body>
<form id="form" method="post" action="../../includes/update_form_handler.php" id="sign-form">
    <!--TODO: add action php to change, ajax-->
    ...
    <div class="container-fluid text-left">
        <div id="person" array>
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12 ">
                    <div class="input-group">
                        <input outline="none" type="text" id="fio" class="form-control border-0"
                               value="<?= $data['fio']; ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <select class="form-select border-0" id="citizenship_id" aria-label="Small select example">
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <div class="input-group">
                        <input type="text" id="birthplace" class="form-control border-0"
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <div class="input-group">
                        <input type="text" id="address" class="form-control border-0"
                               value="<?= $data['address']; ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    ...
                    <select class="form-select border-0" id="accommodations_id" aria-label="Small select example"
                    >
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <input class=" container-fluid form-control border-0" id="phone" id="phone" type="tel"
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <select class="form-select border-0" id="family_id" aria-label="Small select example">
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <div class="input-group">
                        <input type="text" id="family_structure" class="form-control border-0"
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <select class="form-select border-0" id="education_id" aria-label="Small select example">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <div class="row border-top border-bottom">
                        <div class="input-group">
                            <b>Дата окончания:</b>
                            <div class="form-group">
                                <input type="date" id="education_date" class="form-control border-0"
                    ...
                    <div class="row border-top border-bottom">
                        <div class="input-group">
                            ...
                            <input type="text" id="education_facility" class="form-control border-0"
                    ...
                    <div class="row border-top border-bottom">
                        <div class="input-group">
                            <b>Факультет:</b>
                            <input type="text" id="education_faculty" class="form-control border-0"
        ...
        <div id="workorg" array>
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <div class="input-group">
                        <input type="text" id="organization" class="form-control border-0"
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <div class="input-group">
                        <input type="text" id="post" class="form-control border-0"
                               value="<?= $data['post']; ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-2 col-md-3 col-sm-3">
                    <div class="form-group">
                        <input type="date" id="admission_date" class="form-control border-0"
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-2 col-md-3 col-sm-3">
                    <div class="form-group">
                        <input type="date" id="dismissal_date" id="dismissal_date" class="form-control border-0"
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <select class="form-select border-0" id="dismissal_reason_id" id="dismissal_reason_id"
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <!-- Допилить. Связь с БД -->
                    <select class="form-select border-0" id="applypost_id" aria-label="Small select example">
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <select class="form-select border-0" id="isagree_position" aria-label="Small select example">
                        <option value="1" <?= $data['isagree_position'] == 1 ? 'selected' : '' ?>>Да</option>
                        <!-- TODO Подумать как лучше сделать будет с Да Нет выводом -->
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <select class="form-select border-0" id="isagree_removal" aria-label="Small select example">
                        <option value="1" <?= $data['isagree_removal'] == 1 ? 'selected' : '' ?>>Да</option>
                        <!-- TODO Подумать как лучше сделать будет с Да Нет выводом -->
        ...
        <div id="skills" array>
            ...
            <div class="row border-top border-bottom">
                <div class="col-lg-5 col-md-5 col-sm-12 border-end"><b>Навыки владения компьютером </b>(необходимое
                    выбрать)<br></div>
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <select class="form-select border-0" id="pc_skills_id" aria-label="Small select example">
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <div class="input-group">
                        <input type="text" id="languages" class="form-control border-0"
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <!-- Допилить. Связь с БД -->
                    <div class="input-group">
                        <input type="text" id="hobbies" class="form-control border-0"
                               value="<?= $data['hobbies']; ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <!-- Допилить. Связь с БД -->
                    <div class="input-group">
                        <input type="text" id="advantages" class="form-control border-0"
